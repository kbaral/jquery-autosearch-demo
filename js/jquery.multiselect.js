 ...
 *     $('select[multiple]').multiselect({ texts: { placeholder: '-- select --' } });
...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        _addOption: function( container, option ) {
            ...
            var thisCheckbox = $('<input type="checkbox" value=""/>')
                .val( option.value )                
            ...
            var label = $('<label></label>').attr( 'for', 'ms-opt-'+ msCounter ).attr('title',option.des );
